...
@pytest.mark.parametrize("start_numbers, expected", [(1234567890123456, "1234 56** **** 3456"),
...
@pytest.mark.parametrize("start_number, expected", [(73654108430135874305, "**4305"),
                                                    (73654108430135876890, "**6890")])
