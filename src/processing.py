def filter_by_state(list_of_dict, state_key="EXECUTED") -> list[dict]:
    """Функция возвращает список словарей только тех где ключ равен 'state_key' """
    new_list_dict = []
...
def sort_by_date(list_of_dict, key_data=True) -> list[dict]:
    """Функция возвращающая отсортированый список словарей по дате по убыванию по умалчанию"""
    if key_data:
